import { NotificationStrategiesCreateUsecase } from '@core/application/usecases/crud-usecases/notification-strategies-create';
import { NotificationStrategiesDeleteUsecase } from '@core/application/usecases/crud-usecases/notification-strategies-delete';
import { NotificationStrategiesGetUsecase } from '@core/application/usecases/crud-usecases/notification-strategies-get';
import { NotificationStrategiesUpdateUsecase } from '@core/application/usecases/crud-usecases/notification-strategies-update';
import { NotificationStrategiesViewUsecase } from '@core/application/usecases/crud-usecases/notification-strategies-view';
...
} from '../dtos/crud-dtos/notificationStrategies.crud.controllers.dto';
...
export class NotificationStrategiesCrudController {
  ...
  async findAll(@Body() body: NotificationStrategiesGetDto) {
    const notificationStrategiesGetUsecase = new NotificationStrategiesGetUsecase({
      notificationStrategyRepository: this.repositoryImpl,
    });
